...
Why use Qubes OS
----------------
If I had a {insert coin of choice} for every time I read reasons for and against using Qubes OS or Linux I wouldn't stress about making money.
And it is funny because you have the same type of people on both sides of the conversation for Windows/Mac -> Linux and Linux -> Qubes OS.
